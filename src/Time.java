...
public class Time extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmb_2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Day", "Hours", "Minute", "Seconds" }));
        ...
        cmb_1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Day", "Hours", "Minute", "Seconds", " " }));
    ...
    private void cmb_2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmb_2ItemStateChanged
        ...
        if(cb1 == "Day")
        {
            ...
            if(cb2 == "Hours")
            {
                txt_2.setText(num1*24 +"");
            }
            if(cb2 == "Minute")
            txt_2.setText(num1*(24*60) + "");
            if(cb2 == "Seconds")
            txt_2.setText(num1*(24*60*60)+ "");
        }
        if(cb1 == "Hours")
        {
            if(cb2 == "Day")
            ...
            if(cb2 == "Minute")
            txt_2.setText(num1*(60) + "");
            if(cb2 == "Seconds")
            txt_2.setText(num1*(60*60)+ "");
        }
        if(cb1 == "Minute")
        {
            if(cb2 == "Day")
