...
public class Weight extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmb_2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tan", "Ta", "Yen", "Kg", "Hg", "Dag", "g" }));
        ...
        cmb_1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tan", "Ta", "Yen", "Kg", "Hg", "Dag", "g" }));
    ...
    private void txt_1CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txt_1CaretUpdate
        ...
        if(cb1 == "Tan")
        {
            ...
            if(cb2 == "Ta")
            {
                txt_2.setText(num1*10 +"");
            }
            if(cb2 == "Yen")
            txt_2.setText(num1*10*10 + "");
            if(cb2 == "Kg")
            txt_2.setText(num1*10*10*10+ "");
            if(cb2 == "Hg")
            txt_2.setText(num1 *10000 + "");
            if(cb2 == "Dag")
            txt_2.setText(num1 *100000 + "");
            if(cb2 == "g")
            txt_2.setText(num1 *1000000 + "");
        }
        if(cb1 == "Ta")
        {
            if(cb2 == "Tan")
            ...
            txt_2.setText(num1*10 + "");
            if(cb2 == "Kg")
            txt_2.setText(num1*100+ "");
            if(cb2 == "Hg")
            txt_2.setText(num1*1000+ "");
            if(cb2 == "Dag")
            txt_2.setText(num1*10000+ "");
            if(cb2 == "g")
            txt_2.setText(num1*100000+ "");
