...
public class Data extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmb_2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bytes", "Kb", "Mb", "Gb" }));
        ...
        cmb_1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bytes", "Kb", "Mb", "Gb", " " }));
      ...
      if(cb1 == "Bytes")
          {
              ...
              if(cb2 == "Kb")
                  {
                  txt_2.setText(num1/1024 +"");
                  }
              if(cb2 == "Mb")
                  txt_2.setText(num1/(1024*1024) + "");
              if(cb2 == "Gb")
                  txt_2.setText(num1/(1024*1024*1024)+ "");
          }
      if(cb1 == "Kb")
          {
              if(cb2 == "Bytes")
